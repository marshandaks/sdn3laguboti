...
@section('content')
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="uploadModalLabel">Upload Visi</h5>
        ...
        <div class="modal fade" id="editModal{{ $item->id }}" tabindex="-1"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{ route('visi.update', $item->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="#" class="btn btn-warning"
                                        data-bs-target="#editModalMisi{{ $item->id }}" data-bs-toggle="modal">Edit</a>
    ...
    <div class="modal fade" id="uploadModalMisi" tabindex="-1" aria-labelledby="uploadModalMisiLabel"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="uploadModalMisiLabel">Upload Misi</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
